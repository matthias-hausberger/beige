...
<Note>
**Arrays replace, they don't merge.** The deep-merge recursively merges nested objects, but arrays and primitives in the agent override **replace** the base value entirely. If you need both the base entries and new ones, repeat them all in the override. See the [Config Reference](/agents/configuration#agentstoolconfigs) for details and examples.
</Note>
