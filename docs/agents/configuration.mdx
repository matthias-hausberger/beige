---
title: "Configuration"
description: "Complete config.json5 reference"
---

For a higher-level overview, see [Agents](/agents).
...
See [Installation](/installation) for the full picture on the two install modes.
...
See [Toolkits](/tools/toolkits) for installing and managing toolkits.
