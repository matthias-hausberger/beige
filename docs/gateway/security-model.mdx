...
```json
{"ts":"2026-03-05T12:00:00.000Z","agent":"travel","type":"core_tool","tool":"exec","args":["kv set trip:paris March 15"],"decision":"allowed","durationMs":45,"exitCode":0,"outputBytes":23}
