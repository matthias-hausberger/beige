...
agents: {
  ...
  notifier: {
    ...
    toolConfigs: {
      slack: {
        // Arrays replace the base value entirely — repeat entries you
        // want to keep and omit entries you want to unblock.
        // Here "messages send" is removed from the deny list:
