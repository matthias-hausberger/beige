...
`restart` performs an in-place graceful restart — it shuts down the running process and starts a new one. Use this after changing your config or installing new tools.
